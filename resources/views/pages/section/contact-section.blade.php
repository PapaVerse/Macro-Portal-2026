            ...
            <div class="space-y-12">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-10">
                        <div>
                            ...
                            <div class="space-y-4 text-slate-700 text-sm font-bold">
                                ...
                                <a href="tel:+63464772499" class="flex items-center gap-3 hover:text-blue-600 transition-colors group">
                                    <span class="p-2 bg-slate-100 rounded-lg group-hover:bg-blue-50">📞</span> (+63 46) 477-2499
                                </a>
                                <a href="mailto:sales@macrowiring.co" class="flex items-center gap-3 hover:text-blue-600 transition-colors group">
                                    <span class="p-2 bg-slate-100 rounded-lg group-hover:bg-blue-50">✉️</span> sales@macrowiring.co
                                </a>
                            </div>
                        </div>
                ...
                <div class="mt-20 border-l-4 border-slate-200 pl-8 group hover:border-blue-600 transition-colors">
                    ...
                    <p class="text-slate-600 leading-relaxed mb-6 font-medium">
                        Lot 3 Block 17 Phase 4, Cavite Economic Zone <br>
                    ...
                    <div class="rounded-3xl overflow-hidden shadow-2xl shadow-slate-200 border border-slate-100 grayscale hover:grayscale-0 transition-all duration-1000">
                        <iframe src="https://maps.google.com/maps?q=Cavite%20Economic%20Zone%20Rosario%20Cavite&t=&z=15&ie=UTF8&iwloc=&output=embed" width="100%" height="220" class="w-full" loading="lazy" style="border:0;"></iframe>
                    </div>
                </div>
            </div>
