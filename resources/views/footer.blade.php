        ...
        <div>
            ...
            <ul class="space-y-3 text-gray-400 text-sm">
                <li>
                    ...
                    <a href="tel:+63464377204" class="hover:text-blue-400 transition">(+63 46) 437-7204</a> <br>
                    <a href="tel:+634643772443" class="hover:text-blue-400 transition">(+63 46) 437-2443</a> <br>
                    <a href="tel:+634643772499" class="hover:text-blue-400 transition">(+63 46) 437-2499</a>
                </li>
                <li>
                        ...
                        <div x-data="{ active: null }" class="space-y-3">
                            <div class="border border-slate-100 rounded-2xl overflow-hidden shadow-sm">
                                <button @click="active = (active === 1 ? null : 1)" class="w-full p-5 text-left flex justify-between items-center bg-slate-50 hover:bg-slate-100 transition-colors">
                                    ...
                                    <svg class="w-5 h-5 text-blue-500 transition-transform" :class="active === 1 ? 'rotate-180' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="border border-slate-100 rounded-2xl overflow-hidden shadow-sm">
                                <button @click="active = (active === 2 ? null : 2)" class="w-full p-5 text-left flex justify-between items-center bg-slate-50 hover:bg-slate-100 transition-colors">
                                    ...
                                    <svg class="w-5 h-5 text-blue-500 transition-transform" :class="active === 2 ? 'rotate-180' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                                    </svg>
                                </button>
                            ...
                            <div class="border border-slate-100 rounded-2xl overflow-hidden shadow-sm">
                                <button @click="active = (active === 3 ? null : 3)" class="w-full p-5 text-left flex justify-between items-center bg-slate-50 hover:bg-slate-100 transition-colors">
                                    ...
                                    <svg class="w-5 h-5 text-blue-500 transition-transform" :class="active === 3 ? 'rotate-180' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                                    </svg>
                                </button>
                    ...
                    <template x-if="modalType !== 'faq'">
                        <label class="flex items-center gap-4 cursor-pointer group mb-6">
                            <div class="relative">
                                ...
                                <svg class="absolute inset-0 w-7 h-7 text-white opacity-0 peer-checked:opacity-100 p-1.5 transition-opacity" fill="none" stroke="currentColor" stroke-width="4" viewBox="0 0 24 24">
